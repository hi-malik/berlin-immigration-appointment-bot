...
class WebDriver:
    ...
    def __enter__(self) -> webdriver.Chrome:
        ...
        self._driver = webdriver.Chrome(executable_path='/Users/jaidevsinghmalik/Desktop/berlin-auslanderbehorde-termin-bot/chromedriver', options=options)
...
class BerlinBot:
    ...
    def enter_form(driver: webdriver.Chrome):
        ...
        driver.find_element(By.XPATH, '//*[@id="inner-436-0-2"]/div/div[1]/label/p').click()
        time.sleep(2)

        # b/c of stufy
        driver.find_element(By.XPATH, '//*[@id="inner-436-0-2"]/div/div[2]/div/div[5]/label').click()
        time.sleep(4)
